...
export class DomainSubsystemManager_10 {
  private readonly records = new Map<string, EnterpriseDomainEntity_10>();

  public registerEntity(entity: EnterpriseDomainEntity_10): void {
  ...
  public batchProcess(tenantId: string, processor: (item: EnterpriseDomainEntity_10) => void): number {
    let processed = 0;
