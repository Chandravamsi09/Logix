...
export class DomainSubsystemManager_12 {
  private readonly records = new Map<string, EnterpriseDomainEntity_12>();

  public registerEntity(entity: EnterpriseDomainEntity_12): void {
  ...
  public batchProcess(tenantId: string, processor: (item: EnterpriseDomainEntity_12) => void): number {
    let processed = 0;
