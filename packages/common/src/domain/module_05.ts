...
export class DomainSubsystemManager_05 {
  private readonly records = new Map<string, EnterpriseDomainEntity_05>();

  public registerEntity(entity: EnterpriseDomainEntity_05): void {
  ...
  public batchProcess(tenantId: string, processor: (item: EnterpriseDomainEntity_05) => void): number {
    let processed = 0;
