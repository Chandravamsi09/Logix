...
export class DomainSubsystemManager_15 {
  private readonly records = new Map<string, EnterpriseDomainEntity_15>();

  public registerEntity(entity: EnterpriseDomainEntity_15): void {
  ...
  public batchProcess(tenantId: string, processor: (item: EnterpriseDomainEntity_15) => void): number {
    let processed = 0;
