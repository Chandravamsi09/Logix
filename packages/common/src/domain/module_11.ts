...
export class DomainSubsystemManager_11 {
  private readonly records = new Map<string, EnterpriseDomainEntity_11>();

  public registerEntity(entity: EnterpriseDomainEntity_11): void {
  ...
  public batchProcess(tenantId: string, processor: (item: EnterpriseDomainEntity_11) => void): number {
    let processed = 0;
