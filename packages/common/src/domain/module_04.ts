...
export class DomainSubsystemManager_04 {
  private readonly records = new Map<string, EnterpriseDomainEntity_04>();

  public registerEntity(entity: EnterpriseDomainEntity_04): void {
  ...
  public batchProcess(tenantId: string, processor: (item: EnterpriseDomainEntity_04) => void): number {
    let processed = 0;
