...
export class DomainSubsystemManager_14 {
  private readonly records = new Map<string, EnterpriseDomainEntity_14>();

  public registerEntity(entity: EnterpriseDomainEntity_14): void {
  ...
  public batchProcess(tenantId: string, processor: (item: EnterpriseDomainEntity_14) => void): number {
    let processed = 0;
