...
export class DomainSubsystemManager_02 {
  private readonly records = new Map<string, EnterpriseDomainEntity_02>();

  public registerEntity(entity: EnterpriseDomainEntity_02): void {
  ...
  public batchProcess(tenantId: string, processor: (item: EnterpriseDomainEntity_02) => void): number {
    let processed = 0;
