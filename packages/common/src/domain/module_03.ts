...
export class DomainSubsystemManager_03 {
  private readonly records = new Map<string, EnterpriseDomainEntity_03>();

  public registerEntity(entity: EnterpriseDomainEntity_03): void {
  ...
  public batchProcess(tenantId: string, processor: (item: EnterpriseDomainEntity_03) => void): number {
    let processed = 0;
