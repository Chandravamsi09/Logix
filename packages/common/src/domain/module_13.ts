...
export class DomainSubsystemManager_13 {
  private readonly records = new Map<string, EnterpriseDomainEntity_13>();

  public registerEntity(entity: EnterpriseDomainEntity_13): void {
  ...
  public batchProcess(tenantId: string, processor: (item: EnterpriseDomainEntity_13) => void): number {
    let processed = 0;
