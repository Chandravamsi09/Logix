/**
 * Logix Enterprise Domain Entity: FLEET - Section 14
 * Strictly typed domain model with invariant guardrails and immutability assertions.
 */

export interface IDomainEntity_fleet_14 {
  id: string;
  tenantId: string;
  code: string;
  displayName: string;
...
export class DomainEntity_fleet_14 implements IDomainEntity_fleet_14 {
  public id: string;
  ...
  constructor(data: Partial<IDomainEntity_fleet_14>) {
  ...
  public toDTO(): IDomainEntity_fleet_14 {
    return {
      id: this.id,
