/**
 * Logix Enterprise Domain Entity: FLEET - Section 01
 * Strictly typed domain model with invariant guardrails and immutability assertions.
 */

export interface IDomainEntity_fleet_01 {
  id: string;
  tenantId: string;
  code: string;
  displayName: string;
...
export class DomainEntity_fleet_01 implements IDomainEntity_fleet_01 {
  public id: string;
  ...
  constructor(data: Partial<IDomainEntity_fleet_01>) {
  ...
  public toDTO(): IDomainEntity_fleet_01 {
    return {
      id: this.id,
