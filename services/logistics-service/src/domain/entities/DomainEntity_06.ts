/**
 * Logix Enterprise Domain Entity: FLEET - Section 06
 * Strictly typed domain model with invariant guardrails and immutability assertions.
 */

export interface IDomainEntity_fleet_06 {
  id: string;
  tenantId: string;
  code: string;
  displayName: string;
...
export class DomainEntity_fleet_06 implements IDomainEntity_fleet_06 {
  public id: string;
  ...
  constructor(data: Partial<IDomainEntity_fleet_06>) {
  ...
  public toDTO(): IDomainEntity_fleet_06 {
    return {
      id: this.id,
