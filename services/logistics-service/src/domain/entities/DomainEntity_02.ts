/**
 * Logix Enterprise Domain Entity: FLEET - Section 02
 * Strictly typed domain model with invariant guardrails and immutability assertions.
 */

export interface IDomainEntity_fleet_02 {
  id: string;
  tenantId: string;
  code: string;
  displayName: string;
...
export class DomainEntity_fleet_02 implements IDomainEntity_fleet_02 {
  public id: string;
  ...
  constructor(data: Partial<IDomainEntity_fleet_02>) {
  ...
  public toDTO(): IDomainEntity_fleet_02 {
    return {
      id: this.id,
