/**
 * Logix Enterprise Domain Entity: WAREHOUSE - Section 11
 * Strictly typed domain model with invariant guardrails and immutability assertions.
 */

export interface IDomainEntity_warehouse_11 {
  id: string;
  tenantId: string;
  code: string;
  displayName: string;
...
export class DomainEntity_warehouse_11 implements IDomainEntity_warehouse_11 {
  public id: string;
  ...
  constructor(data: Partial<IDomainEntity_warehouse_11>) {
  ...
  public toDTO(): IDomainEntity_warehouse_11 {
    return {
      id: this.id,
