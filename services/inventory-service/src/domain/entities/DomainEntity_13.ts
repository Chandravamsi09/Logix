/**
 * Logix Enterprise Domain Entity: WAREHOUSE - Section 13
 * Strictly typed domain model with invariant guardrails and immutability assertions.
 */

export interface IDomainEntity_warehouse_13 {
  id: string;
  tenantId: string;
  code: string;
  displayName: string;
...
export class DomainEntity_warehouse_13 implements IDomainEntity_warehouse_13 {
  public id: string;
  ...
  constructor(data: Partial<IDomainEntity_warehouse_13>) {
  ...
  public toDTO(): IDomainEntity_warehouse_13 {
    return {
      id: this.id,
