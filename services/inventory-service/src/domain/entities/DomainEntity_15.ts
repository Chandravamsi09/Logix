/**
 * Logix Enterprise Domain Entity: WAREHOUSE - Section 15
 * Strictly typed domain model with invariant guardrails and immutability assertions.
 */

export interface IDomainEntity_warehouse_15 {
  id: string;
  tenantId: string;
  code: string;
  displayName: string;
...
export class DomainEntity_warehouse_15 implements IDomainEntity_warehouse_15 {
  public id: string;
  ...
  constructor(data: Partial<IDomainEntity_warehouse_15>) {
  ...
  public toDTO(): IDomainEntity_warehouse_15 {
    return {
      id: this.id,
