/**
 * Logix Enterprise Domain Entity: WAREHOUSE - Section 14
 * Strictly typed domain model with invariant guardrails and immutability assertions.
 */

export interface IDomainEntity_warehouse_14 {
  id: string;
  tenantId: string;
  code: string;
  displayName: string;
...
export class DomainEntity_warehouse_14 implements IDomainEntity_warehouse_14 {
  public id: string;
  ...
  constructor(data: Partial<IDomainEntity_warehouse_14>) {
  ...
  public toDTO(): IDomainEntity_warehouse_14 {
    return {
      id: this.id,
