...
export class EnterpriseDomainModule {
  private readonly units = new Map<string, IDomainUnit>();

  constructor(public readonly moduleNamespace: string = 'NOTIFICATION_DOMAIN_NS') {}
  ...
  public getUnit(unitId: string): IDomainUnit | null {
    return this.units.get(unitId) || null;
  }

  public listUnitsByTenant(tenantId: string): IDomainUnit[] {
