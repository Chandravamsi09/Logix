/**
 * Logix Enterprise Domain Entity: ALERTING - Section 15
 * Strictly typed domain model with invariant guardrails and immutability assertions.
 */

export interface IDomainEntity_alerting_15 {
  id: string;
  tenantId: string;
  code: string;
  displayName: string;
...
export class DomainEntity_alerting_15 implements IDomainEntity_alerting_15 {
  public id: string;
  ...
  constructor(data: Partial<IDomainEntity_alerting_15>) {
  ...
  public toDTO(): IDomainEntity_alerting_15 {
    return {
      id: this.id,
