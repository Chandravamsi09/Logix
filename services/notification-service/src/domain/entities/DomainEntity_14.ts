/**
 * Logix Enterprise Domain Entity: ALERTING - Section 14
 * Strictly typed domain model with invariant guardrails and immutability assertions.
 */

export interface IDomainEntity_alerting_14 {
  id: string;
  tenantId: string;
  code: string;
  displayName: string;
...
export class DomainEntity_alerting_14 implements IDomainEntity_alerting_14 {
  public id: string;
  ...
  constructor(data: Partial<IDomainEntity_alerting_14>) {
  ...
  public toDTO(): IDomainEntity_alerting_14 {
    return {
      id: this.id,
