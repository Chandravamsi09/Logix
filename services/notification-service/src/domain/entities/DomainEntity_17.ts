/**
 * Logix Enterprise Domain Entity: ALERTING - Section 17
 * Strictly typed domain model with invariant guardrails and immutability assertions.
 */

export interface IDomainEntity_alerting_17 {
  id: string;
  tenantId: string;
  code: string;
  displayName: string;
...
export class DomainEntity_alerting_17 implements IDomainEntity_alerting_17 {
  public id: string;
  ...
  constructor(data: Partial<IDomainEntity_alerting_17>) {
  ...
  public toDTO(): IDomainEntity_alerting_17 {
    return {
      id: this.id,
