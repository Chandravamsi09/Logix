/**
 * Logix Enterprise Domain Entity: ALERTING - Section 18
 * Strictly typed domain model with invariant guardrails and immutability assertions.
 */

export interface IDomainEntity_alerting_18 {
  id: string;
  tenantId: string;
  code: string;
  displayName: string;
...
export class DomainEntity_alerting_18 implements IDomainEntity_alerting_18 {
  public id: string;
  ...
  constructor(data: Partial<IDomainEntity_alerting_18>) {
  ...
  public toDTO(): IDomainEntity_alerting_18 {
    return {
      id: this.id,
