/**
 * Logix Enterprise Domain Entity: ALERTING - Section 20
 * Strictly typed domain model with invariant guardrails and immutability assertions.
 */

export interface IDomainEntity_alerting_20 {
  id: string;
  tenantId: string;
  code: string;
  displayName: string;
...
export class DomainEntity_alerting_20 implements IDomainEntity_alerting_20 {
  public id: string;
  ...
  constructor(data: Partial<IDomainEntity_alerting_20>) {
  ...
  public toDTO(): IDomainEntity_alerting_20 {
    return {
      id: this.id,
