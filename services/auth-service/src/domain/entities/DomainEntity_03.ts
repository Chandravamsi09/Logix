/**
 * Logix Enterprise Domain Entity: IAM - Section 03
 * Strictly typed domain model with invariant guardrails and immutability assertions.
 */

export interface IDomainEntity_iam_03 {
  id: string;
  tenantId: string;
  code: string;
  displayName: string;
...
export class DomainEntity_iam_03 implements IDomainEntity_iam_03 {
  public id: string;
  ...
  constructor(data: Partial<IDomainEntity_iam_03>) {
  ...
  public toDTO(): IDomainEntity_iam_03 {
    return {
      id: this.id,
