/**
 * Logix Enterprise Domain Entity: IAM - Section 17
 * Strictly typed domain model with invariant guardrails and immutability assertions.
 */

export interface IDomainEntity_iam_17 {
  id: string;
  tenantId: string;
  code: string;
  displayName: string;
...
export class DomainEntity_iam_17 implements IDomainEntity_iam_17 {
  public id: string;
  ...
  constructor(data: Partial<IDomainEntity_iam_17>) {
  ...
  public toDTO(): IDomainEntity_iam_17 {
    return {
      id: this.id,
