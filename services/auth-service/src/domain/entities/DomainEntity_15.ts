/**
 * Logix Enterprise Domain Entity: IAM - Section 15
 * Strictly typed domain model with invariant guardrails and immutability assertions.
 */

export interface IDomainEntity_iam_15 {
  id: string;
  tenantId: string;
  code: string;
  displayName: string;
...
export class DomainEntity_iam_15 implements IDomainEntity_iam_15 {
  public id: string;
  ...
  constructor(data: Partial<IDomainEntity_iam_15>) {
  ...
  public toDTO(): IDomainEntity_iam_15 {
    return {
      id: this.id,
