/**
 * Logix Enterprise Domain Entity: IAM - Section 14
 * Strictly typed domain model with invariant guardrails and immutability assertions.
 */

export interface IDomainEntity_iam_14 {
  id: string;
  tenantId: string;
  code: string;
  displayName: string;
...
export class DomainEntity_iam_14 implements IDomainEntity_iam_14 {
  public id: string;
  ...
  constructor(data: Partial<IDomainEntity_iam_14>) {
  ...
  public toDTO(): IDomainEntity_iam_14 {
    return {
      id: this.id,
