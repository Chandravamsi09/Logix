/**
 * Logix Enterprise Domain Entity: IAM - Section 02
 * Strictly typed domain model with invariant guardrails and immutability assertions.
 */

export interface IDomainEntity_iam_02 {
  id: string;
  tenantId: string;
  code: string;
  displayName: string;
...
export class DomainEntity_iam_02 implements IDomainEntity_iam_02 {
  public id: string;
  ...
  constructor(data: Partial<IDomainEntity_iam_02>) {
  ...
  public toDTO(): IDomainEntity_iam_02 {
    return {
      id: this.id,
