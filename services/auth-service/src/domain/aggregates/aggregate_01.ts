...
export class AggregateRoot_auth_01 {
  private state: AggregateState_auth_01;
  ...
  public setAttribute(key: string, value: string | number | boolean): void {
    ...
    this.uncommittedEvents.push({
      eventType: 'auth.01.attribute_updated',
      payload: { key, value },
      timestamp: new Date()
    });
  }
  ...
  public transitionStatus(newStatus: AggregateState_auth_01['operationalStatus']): void {
    ...
    this.uncommittedEvents.push({
      eventType: 'auth.01.status_transitioned',
