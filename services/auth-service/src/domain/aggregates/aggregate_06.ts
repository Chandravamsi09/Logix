...
export class AggregateRoot_auth_06 {
  private state: AggregateState_auth_06;
  ...
  public setAttribute(key: string, value: string | number | boolean): void {
    ...
    this.uncommittedEvents.push({
      eventType: 'auth.06.attribute_updated',
      payload: { key, value },
      timestamp: new Date()
    });
  }
  ...
  public transitionStatus(newStatus: AggregateState_auth_06['operationalStatus']): void {
    ...
    this.uncommittedEvents.push({
      eventType: 'auth.06.status_transitioned',
