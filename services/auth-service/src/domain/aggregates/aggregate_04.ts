...
export class AggregateRoot_auth_04 {
  private state: AggregateState_auth_04;
  ...
  public setAttribute(key: string, value: string | number | boolean): void {
    ...
    this.uncommittedEvents.push({
      eventType: 'auth.04.attribute_updated',
      payload: { key, value },
      timestamp: new Date()
    });
  }
  ...
  public transitionStatus(newStatus: AggregateState_auth_04['operationalStatus']): void {
    ...
    this.uncommittedEvents.push({
      eventType: 'auth.04.status_transitioned',
