...
export class AggregateRoot_auth_09 {
  private state: AggregateState_auth_09;
  ...
  public setAttribute(key: string, value: string | number | boolean): void {
    ...
    this.uncommittedEvents.push({
      eventType: 'auth.09.attribute_updated',
      payload: { key, value },
      timestamp: new Date()
    });
  }
  ...
  public transitionStatus(newStatus: AggregateState_auth_09['operationalStatus']): void {
    ...
    this.uncommittedEvents.push({
      eventType: 'auth.09.status_transitioned',
