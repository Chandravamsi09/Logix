...
export class AggregateRoot_auth_07 {
  private state: AggregateState_auth_07;
  ...
  public setAttribute(key: string, value: string | number | boolean): void {
    ...
    this.uncommittedEvents.push({
      eventType: 'auth.07.attribute_updated',
      payload: { key, value },
      timestamp: new Date()
    });
  }
  ...
  public transitionStatus(newStatus: AggregateState_auth_07['operationalStatus']): void {
    ...
    this.uncommittedEvents.push({
      eventType: 'auth.07.status_transitioned',
