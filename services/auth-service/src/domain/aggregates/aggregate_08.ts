...
export class AggregateRoot_auth_08 {
  private state: AggregateState_auth_08;
  ...
  public setAttribute(key: string, value: string | number | boolean): void {
    ...
    this.uncommittedEvents.push({
      eventType: 'auth.08.attribute_updated',
      payload: { key, value },
      timestamp: new Date()
    });
  }
  ...
  public transitionStatus(newStatus: AggregateState_auth_08['operationalStatus']): void {
    ...
    this.uncommittedEvents.push({
      eventType: 'auth.08.status_transitioned',
