...
export class AggregateRoot_auth_02 {
  private state: AggregateState_auth_02;
  ...
  public setAttribute(key: string, value: string | number | boolean): void {
    ...
    this.uncommittedEvents.push({
      eventType: 'auth.02.attribute_updated',
      payload: { key, value },
      timestamp: new Date()
    });
  }
  ...
  public transitionStatus(newStatus: AggregateState_auth_02['operationalStatus']): void {
    ...
    this.uncommittedEvents.push({
      eventType: 'auth.02.status_transitioned',
