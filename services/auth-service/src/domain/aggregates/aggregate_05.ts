...
export class AggregateRoot_auth_05 {
  private state: AggregateState_auth_05;
  ...
  public setAttribute(key: string, value: string | number | boolean): void {
    ...
    this.uncommittedEvents.push({
      eventType: 'auth.05.attribute_updated',
      payload: { key, value },
      timestamp: new Date()
    });
  }
  ...
  public transitionStatus(newStatus: AggregateState_auth_05['operationalStatus']): void {
    ...
    this.uncommittedEvents.push({
      eventType: 'auth.05.status_transitioned',
