...
export class AggregateRoot_auth_11 {
  private state: AggregateState_auth_11;
  ...
  public setAttribute(key: string, value: string | number | boolean): void {
    ...
    this.uncommittedEvents.push({
      eventType: 'auth.11.attribute_updated',
      payload: { key, value },
      timestamp: new Date()
    });
  }
  ...
  public transitionStatus(newStatus: AggregateState_auth_11['operationalStatus']): void {
    ...
    this.uncommittedEvents.push({
      eventType: 'auth.11.status_transitioned',
