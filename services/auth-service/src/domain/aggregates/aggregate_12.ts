...
export class AggregateRoot_auth_12 {
  private state: AggregateState_auth_12;
  ...
  public setAttribute(key: string, value: string | number | boolean): void {
    ...
    this.uncommittedEvents.push({
      eventType: 'auth.12.attribute_updated',
      payload: { key, value },
      timestamp: new Date()
    });
  }
  ...
  public transitionStatus(newStatus: AggregateState_auth_12['operationalStatus']): void {
    ...
    this.uncommittedEvents.push({
      eventType: 'auth.12.status_transitioned',
