...
export class AggregateRoot_auth_03 {
  private state: AggregateState_auth_03;
  ...
  public setAttribute(key: string, value: string | number | boolean): void {
    ...
    this.uncommittedEvents.push({
      eventType: 'auth.03.attribute_updated',
      payload: { key, value },
      timestamp: new Date()
    });
  }
  ...
  public transitionStatus(newStatus: AggregateState_auth_03['operationalStatus']): void {
    ...
    this.uncommittedEvents.push({
      eventType: 'auth.03.status_transitioned',
