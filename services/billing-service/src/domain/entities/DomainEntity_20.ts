/**
 * Logix Enterprise Domain Entity: LEDGER - Section 20
 * Strictly typed domain model with invariant guardrails and immutability assertions.
 */

export interface IDomainEntity_ledger_20 {
  id: string;
  tenantId: string;
  code: string;
  displayName: string;
...
export class DomainEntity_ledger_20 implements IDomainEntity_ledger_20 {
  public id: string;
  ...
  constructor(data: Partial<IDomainEntity_ledger_20>) {
  ...
  public toDTO(): IDomainEntity_ledger_20 {
    return {
      id: this.id,
