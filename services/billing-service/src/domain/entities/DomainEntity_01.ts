/**
 * Logix Enterprise Domain Entity: LEDGER - Section 01
 * Strictly typed domain model with invariant guardrails and immutability assertions.
 */

export interface IDomainEntity_ledger_01 {
  id: string;
  tenantId: string;
  code: string;
  displayName: string;
...
export class DomainEntity_ledger_01 implements IDomainEntity_ledger_01 {
  public id: string;
  ...
  constructor(data: Partial<IDomainEntity_ledger_01>) {
  ...
  public toDTO(): IDomainEntity_ledger_01 {
    return {
      id: this.id,
