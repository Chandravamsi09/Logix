/**
 * Logix Enterprise Domain Entity: LEDGER - Section 14
 * Strictly typed domain model with invariant guardrails and immutability assertions.
 */

export interface IDomainEntity_ledger_14 {
  id: string;
  tenantId: string;
  code: string;
  displayName: string;
...
export class DomainEntity_ledger_14 implements IDomainEntity_ledger_14 {
  public id: string;
  ...
  constructor(data: Partial<IDomainEntity_ledger_14>) {
  ...
  public toDTO(): IDomainEntity_ledger_14 {
    return {
      id: this.id,
